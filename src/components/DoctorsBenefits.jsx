...
import benefitsData from '../data/doctorsBenefits.json'; // adjust the path
    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {benefitsData.map((item, index) => (
          <div
            key={index}
            className="bg-[#16192b] rounded-xl p-6 shadow-md hover:shadow-lg transition-all border border-[#1E1F50]"
          >
            <div
