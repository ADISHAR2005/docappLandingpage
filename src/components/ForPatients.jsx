    ...
    <section className="text-center py-16 px-4 bg-[#0d0f23] text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
        {features.map((feature, index) => (
          <div
            key={index}
            className="bg-[#16192b] border border-[#2c2f45] rounded-xl p-6 shadow-lg transition-transform duration-300 hover:-translate-y-1"
          >
            {/* Only icon glows */}
            <div className="text-5xl mb-4 transition duration-300 group-hover:animate-pulse group">
